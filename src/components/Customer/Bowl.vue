<template>
    <div>
        ...
        <h1>Base</h1> 
        <ul>
            <li v-for="item in menuItems.base" :key="item.name">{{ item.name }}</li>
        </ul>
        <h1>Protein</h1> 
        <ul>
            <li v-for="item in menuItems.protein" :key="item.name">{{ item.name }}</li>
        </ul>
        <h1>Topping</h1>
        <ul>
            <li v-for="item in menuItems.topping" :key="item.name">{{ item.name }}</li>
        </ul>  
        <h1>Dressing</h1>
        <ul>
